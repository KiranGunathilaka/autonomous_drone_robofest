...
: ${AMENT_CURRENT_PREFIX:="/root/dev/ardpt/droneController/drone_ws/install/auto_drone"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/auto_drone/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/auto_drone/environment/path.sh"
